...
public extension CameraViewController {
    ...
    class func imagePickerViewController(croppingEnabled: Bool, completion: @escaping CameraViewCompletion) -> UINavigationController {
...
open class CameraViewController: UIViewController {
    ...
    var hintLabelEdgeConstraint: NSLayoutConstraint?
    var hintLabelGravityConstraint: NSLayoutConstraint?
    ...
    let hintLabel: UILabel = {
        ...
        label.text = "Center ID card between the lines, hold steady, then press the camera button."
        label.transform = CGAffineTransform(rotationAngle: CGFloat.pi / 2)
        //label.frame = CGRect(x: kPortraitWidth/2, y: kPortraitHeight/2-200, width: 200, height: 30)
        return label
    }()
...
//    }
    ...
    override open func updateViewConstraints() {
        ...
        let padding : CGFloat = portrait ? 50.0 : -50.0
        ...
        self.cameraOverlay.snp.updateConstraints { (make) in
        ...
        self.hintLabel.snp.updateConstraints { (make) in
            //make.left.equalTo(self.view).offset(-(kPortraitWidth/2 - (isIphone5 || isIphone4 ? 35 : isIphone6p6sp7p8p ? 85 : isIphoneX ? 65 : 60)))
        ...
        //self.hintLabel.superview?.backgroundColor = UIColor.red
    ...
    internal func swapCamera() {
        ...
        flashButton.isHidden = cameraView.currentPosition == .front
    }
